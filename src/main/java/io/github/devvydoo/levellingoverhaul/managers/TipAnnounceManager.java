...
public class TipAnnounceManager {
    ...
    public TipAnnounceManager(LevellingOverhaul plugin) {
        this.plugin = plugin;
        ...
        tips.add(String.format("%sArmor %sworks a little different here. Armor will always provide players a %spercent resist %sbased on Armor type, and enchantments.", ChatColor.RED, ChatColor.GRAY, ChatColor.GOLD, ChatColor.GRAY));
        ...
        tips.add(String.format("Armor is %sunbreakable%s. Tools on the other hand still have durability.", ChatColor.GOLD, ChatColor.GRAY));
        ...
        tips.add(String.format("The %sInfinity %senchantment is a chance to conserve arrows rather than making them infinite. Make sure to %sstock up %son ammo!", ChatColor.LIGHT_PURPLE, ChatColor.GRAY, ChatColor.GOLD, ChatColor.GRAY));
        tips.add(String.format("All methods of earning XP via %sexperience orbs %sis removed. You can earn %sXP %sby defeating mobs, earning advancements, and smelting materials to name a few.", ChatColor.GREEN, ChatColor.GRAY, ChatColor.GREEN, ChatColor.GRAY));
