...
public class CustomItemMagicMirror extends CustomItem {
    ...
    public static final NamespacedKey MAGIC_MIRROR_DATA_KEY = new NamespacedKey(LevelingOverhaul.getPlugin(LevelingOverhaul.class), "magic-mirror-data");
    private final LevelingOverhaul plugin;

    public CustomItemMagicMirror(CustomItemType type) {
        super(type);
        this.plugin = LevelingOverhaul.getPlugin(LevelingOverhaul.class);
    }
