...
import io.github.devvydoo.levelingoverhaul.mobs.custommobs.CustomLeveledEntityType;
...
public class LeveledLivingEntity {
        ...
        switch (entity.getType()) {
            ...
            case ENDERMAN:
                switch (entity.getWorld().getEnvironment()){
                    ...
                    default:
                        LevelingOverhaul.getPlugin(LevelingOverhaul.class).getLogger().warning("Could not determine environment for enderman, defaulting to level 1");
                        return 1;
                }
            ...
            case PHANTOM:
                ...
                if (phantom.getSpawningEntity() != null) {
                    Player target = LevelingOverhaul.getPlugin(LevelingOverhaul.class).getServer().getPlayer(phantom.getSpawningEntity());
            ...
            default:
                LevelingOverhaul.getPlugin(LevelingOverhaul.class).getLogger().warning("Entity " + entity + " was not defined to have a level in MobManager. Defaulting to level 1");
                return 1;
        }
    }
    ...
    public static void setEntityAttributes(LivingEntity entity, int level){
        ...
        switch (entity.getType()){
            ...
            default:
                LevelingOverhaul.getPlugin(LevelingOverhaul.class).getLogger().finest("Entity " + entity + " was not defined to have attributes in MobManager. Defaulting to vanilla stats");
                break;
        }
    ...
    public static double calculateEntityHealth(LivingEntity entity, int level){
        ...
        switch (entity.getType()) {
            ...
            default:
                LevelingOverhaul.getPlugin(LevelingOverhaul.class).getLogger().warning("Came across unexpected entity for HP calculation: " + entity.getType());
                multiplier = 1;
                break;
        }
