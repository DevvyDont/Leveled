...
public class MobManager implements Listener {
    ...
    public final static NamespacedKey MOB_LEVEL_KEY = new NamespacedKey(LevelingOverhaul.getPlugin(LevelingOverhaul.class), "mob-level-key");
    // Mobs have this key that determines what their name is
    public final static NamespacedKey MOB_NAME_KEY = new NamespacedKey(LevelingOverhaul.getPlugin(LevelingOverhaul.class), "mob-name-key");
    // Mobs have this key that defines the enum that defines their custom mob status (index of custom mob type enum, -1 if vanilla)
    public final static NamespacedKey MOB_CUSTOM_FLAG_KEY = new NamespacedKey(LevelingOverhaul.getPlugin(LevelingOverhaul.class), "mob-custom-key");
